    ...
    <div class="area-bg__inner">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md">
            <h1 class="b-title-page">Des voitures fiables et durables </h1>
  ...
  <div class="container text-center">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Des voitures fiables et durables</li>
      </ol>
    </nav>
  </div>
                      ...
                      <div class="flip__front">
                        ...
                        <div class="b-goods__inner">
                          ...
                          <div class="b-goods__footer">
                            ...
                            <a href="{{url('/locations/'.$voiture->id)}}">
                                <button class="btn btn-primary btn-lg w-100">Louer</button></a>
                              </div>
                        </div>
                      </div>
